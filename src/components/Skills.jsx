                ...
                <Col lg={6} xs={12}>
                    ...
                    <Card className="skill-nbcard">
                        <Card.Body>
                            ...
                            <Card.Text>HTML, CSS, JavaScript, Bootstrap, ReactJs, Redux, MaterialUi, TypeScript </Card.Text>
                        </Card.Body>
                    </Card>
                    <Card className="skill-nbcard">
                        <Card.Body >
                            <Card.Title>Backend</Card.Title>
                            <Card.Text>MongoDb, Nodejs, ExpressJs</Card.Text>
                        </Card.Body>
                    </Card>
                    <Card className="skill-nbcard">
                        <Card.Body >
                            <Card.Title>Tools</Card.Title>
                            <Card.Text>Git, Visual Studio</Card.Text>
                        </Card.Body>
                    </Card>
                </Col>
                </Row>

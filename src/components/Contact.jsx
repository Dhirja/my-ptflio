                ...
                <Form onSubmit={e => onSubmit(e)}>
                    ...
                    <Col md={12} className="home-about-social">
                        ...
                        <ul className="home-about-social-links">
                            ...
                            <li className="social-icons">
                                <a
                                    href="https://twitter.com/dhirajd76300260"
                                    target="_blank"
                                    rel="noreferrer"
                                    className="icon-colour  home-social-icons"
                                >
                            ...
                            <li className="social-icons">
                                <a
                                    href="https://www.linkedin.com/in/dhiraj-dubey-aa92a1162/"
                                    target="_blank"
                                    rel="noreferrer"
                                    className="icon-colour  home-social-icons"
                                >
                            ...
                            <li className="social-icons">
                                <a
                                    href="mailto://dhirajdubey19965@gmail.com/"
                                    target="_blank"
                                    rel="noreferrer"
                                    className="icon-colour home-social-icons"
                                >

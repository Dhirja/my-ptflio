                  ...
                  <Col lg={8} align='center'>
                    <Card className="nbcard">
                      ...
                      <p>I am a <strong>Full Stack Web Developer</strong> from India. I am graduated from Asansol Engineering college in the Department of <strong>Information Technology</strong>, I am a <strong>passionate developer</strong> and believe in <strong>networking</strong> a lot. I am very enthusiastic about learning new technologies and tools. I'm comfortable working on any domain if I find the project is worth it. You can imagine me focused on the laptop screen and typing or taking down notes. Apart from technical things, I enjoy good books, travelling, mountaineering and playing chess.<br></br>
                        ...
                        <a href="https://drive.google.com/file/d/1vv-d6GgRYrJ65R6Yas_5W9vY5mDbdp0X/view?usp=sharing" download>
                        <Button variant={darkMode ? "outline-light" : "outline-dark"} className='a'>
                  ...
                  <Col lg={4} align='center'>
                    <Card className="nbcard">
                      <Card.Body>
                        ...
                        <br></br>
                        <a href="linkedin.com/in/dhiraj-dubey-aa92a1162" target="_blank" rel="noreferrer noopener">
                           <Button variant={darkMode ? "outline-light" : "outline-dark"} className='a'>
                            <FontAwesomeIcon className="dark" size="lg" icon={faLinkedin}/> Dhiraj Dubey
                          </Button>
                        </a>
                        <a href="https://github.com/Dhirja" target="_blank" rel="noreferrer noopener">
                          <Button variant={darkMode ? "outline-light" : "outline-dark"}>
                            <FontAwesomeIcon className="dark" size="lg" icon={faGithub}/>  Dhiraj Dubey
                          </Button>
                        </a>
